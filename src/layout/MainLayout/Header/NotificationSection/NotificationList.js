...
import { getUserNickName } from '../../../../service/dataService/userService';
import { useMessage } from '../../../../ui-component/MessageContext';
        ...
        <>
          ...
          <Grid item>
            {messages.map((message, index) => (
              <ListItemWrapper key={index} message={message} />
            ))}
          </Grid>
        </>
      )}
